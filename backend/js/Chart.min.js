    ...
    var Ee = {
            ...
            notify: function(t, e, i) {
                var n,
                    ...
                    d = l.length;
                for (n = 0; n < d; ++n)
                    if ("function" == typeof (s = (o = (a = l[n]).plugin)[e]) && ((r = [t].concat(i || [])).push(a.options), !1 === s.apply(o, r)))
                        return !1;
                return !0
            },
                ...
                if (e._isVisible()) {
                    ...
                    if (ut.each(b, function(n, s) {
                        ...
                        var R,
                            ...
                            B = I.lineHeight / 2;
                        if (m)
                            R = e.left + (e.right - e.left) / 2, O = "bottom" === f ? e.bottom - B - A.bottom : e.top + B + A.top;
                        else {
                            var N = "left" === f;
        ...
        var a,
            ...
            l = s.unit || function(t, e, i, n) {
                ...
                for (a = qi.indexOf(t); a < s - 1; ++a)
                    if (r = (o = ji[qi[a]]).steps ? o.steps[o.steps.length - 1] : Hi, o.common && Math.ceil((i - e) / (r * o.size)) <= n)
                        return qi[a];
                return qi[s - 1]
            }(s.minUnit, e, i, n),
            d = Zi(l),
            ...
            buildTicks: function() {
                ...
                return n.min = a, n.max = o, n._unit = s.unit || function(t, e, i, n, a) {
                    ...
                    for (o = qi.length - 1; o >= qi.indexOf(i); o--)
                        if (r = qi[o], ji[r].common && t._adapter.diff(a, n, r) >= e.length)
                            return r;
